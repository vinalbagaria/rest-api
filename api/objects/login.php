...
class Login
    {
        ...
        private $conn;
        private $tableName1 = "user";
        private $tableName2 = "userCredentials";
        ...
        public function checkLogin($emailId,$password){
            $query = "SELECT userId FROM $this->tableName1 WHERE emailId = :emailId ";
            ...
            $getPassword="SELECT userId,password FROM $this->tableName2 WHERE userId=:userId && password=:password";
